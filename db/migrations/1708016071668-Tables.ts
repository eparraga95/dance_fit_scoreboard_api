...
export class Tables1708016071668 implements MigrationInterface {
    name = 'Tables1708016071668'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "players" ("player_id" BIGSERIAL NOT NULL, "nickname" character varying NOT NULL, "password" character varying NOT NULL, "role" character varying NOT NULL, CONSTRAINT "UQ_b087be71894b730ec150a1ed458" UNIQUE ("nickname"), CONSTRAINT "PK_7274d067b855d5824050aaf5e68" PRIMARY KEY ("player_id"))`);
